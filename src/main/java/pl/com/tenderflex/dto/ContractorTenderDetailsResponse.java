...
public class ContractorTenderDetailsResponse {
    ...
    private String awardDecisionFileNameByContractor;
    private String rejectFileNameByContractor;
    ...
    public String getAwardDecisionFileNameByContractor() {
        return awardDecisionFileNameByContractor;
    }

    public void setAwardDecisionFileNameByContractor(String awardDecisionFileNameByContractor) {
        this.awardDecisionFileNameByContractor = awardDecisionFileNameByContractor;
    }

    public String getRejectFileNameByContractor() {
        return rejectFileNameByContractor;
    }

    public void setRejectFileNameByContractor(String rejectFileNameByContractor) {
        this.rejectFileNameByContractor = rejectFileNameByContractor;
    }
}