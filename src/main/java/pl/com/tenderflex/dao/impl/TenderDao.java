...
public class TenderDao implements TenderRepository {
    ...
    public static final String ADD_NEW_TENDER_QUERY = "INSERT INTO "
            ...
            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    public static final String GET_TENDERS_BY_CONTRACTOR_QUERY = "SELECT cp.id AS con_person_id, first_name, last_name, phone, "
            + "org.id AS organization_id, organization_name, national_registration_number, country, city, publication_date, "
            + "ten.id AS tender_id, contractor_id, cpv_code, tender_type, details, min_price, max_price, currency, deadline, "
            + "deadline_for_signed_contract, status, contract_file_name, award_decision_file_name, reject_decision_file_name "
    ...
    public static final String GET_TENDERS_BY_CONDITION_QUERY = "SELECT cp.id AS con_person_id, first_name, last_name, phone, "
            + "org.id AS organization_id, organization_name, national_registration_number, country, city, publication_date, "
            + "ten.id AS tender_id, contractor_id, cpv_code, tender_type, details, min_price, max_price, currency, deadline, "
            + "deadline_for_signed_contract, status, contract_file_name, award_decision_file_name, reject_decision_file_name "
            + "FROM tenders ten LEFT JOIN organizations org ON org.id = ten.organization_id "
    ...
    public static final String GET_TENDER_BY_ID_QUERY = "SELECT cp.id AS con_person_id, first_name, last_name, phone, org.id AS organization_id, "
            + "organization_name, national_registration_number, country, city, publication_date, ten.id AS tender_id, contractor_id, "
