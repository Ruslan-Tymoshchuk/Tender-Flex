    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .antMatchers("/**/document/**")
              .hasAuthority(String.valueOf(ERole.CONTRACTOR))
            .antMatchers("/**/tender/create")
              .hasAuthority(String.valueOf(ERole.CONTRACTOR))
            .antMatchers("/**/tender/amount_tenders_by_contractor")
              .hasAuthority(String.valueOf(ERole.CONTRACTOR))
            .antMatchers("/**/tender/tenders_by_contractor") 
              .hasAuthority(String.valueOf(ERole.CONTRACTOR))
            .antMatchers("/**/tender/all_tenders")
              .hasAuthority(String.valueOf(ERole.BIDDER))     
            .antMatchers("/**/tender/details/{id}")
              .hasAuthority(String.valueOf(ERole.CONTRACTOR))
            .anyRequest()
              .authenticated()
            .and()
